...
import type { AppProxyContext as IAppProxyContext, AppProxyContextWithSession as IAppProxyContextWithSession } from './authenticate/public/appProxy/types';
import type { AdminApiContext as IAdminApiContext, StorefrontContext as IStorefrontContext } from './clients';
...
type ShopifyConfig<App> = App extends ShopifyApp<infer Config extends AppConfigArg> ? Config : never;
...
//# sourceMappingURL=types-contexts.d.ts.map