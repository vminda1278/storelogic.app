import { ConfigParams as ApiConfigArg, ConfigInterface as ApiConfig, Session, ApiVersion, WebhookHandler } from '@shopify/shopify-api';
import { SessionStorage } from '@shopify/shopify-app-session-storage';
import type { BillingConfigOneTimePlan, BillingConfigSubscriptionLineItemPlan } from '@shopify/shopify-api';
import type { ApiFutureFlags, FutureFlagOptions, FutureFlags } from './future/flags';
...
export interface BillingConfigWithLineItems {
    [plan: string]: BillingConfigOneTimePlan | BillingConfigSubscriptionLineItemPlan;
}
export interface AppConfigArg<Storage extends SessionStorage = SessionStorage, Future extends FutureFlagOptions = FutureFlagOptions> extends Omit<ApiConfigArg<ApiFutureFlags<Future>>, 'hostName' | 'hostScheme' | 'apiVersion' | 'isCustomStoreApp' | 'isEmbeddedApp' | 'future' | 'billing' | 'restResources'> {
    /**
...
export interface AppConfig<Storage extends SessionStorage = SessionStorage> extends Omit<ApiConfig, 'future' | 'billing'> {
